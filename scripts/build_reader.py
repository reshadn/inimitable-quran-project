...
def main():
    ...
    research_files = ['source-dossier.md', 'charter.md', 'book-map.md', 'methods-and-studies.md']
    ...
    evidence = []
    for filename in ['sources-19-4.json', 'sources-asr.json']:
    ...
    doc = f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>The Qur’an Examined | First research edition</title><style>{css}</style></head><body>
<a class="skip" href="#main">Skip to content</a>
<header class="cover"><div class="eyebrow">THE QUR’AN EXAMINED · RESEARCH EDITION 01</div><h1>Begin with<br>the language.</h1><p class="deck">Language, meaning, and the case for revelation.<br>An invitation to inspect the evidence.</p><div class="cover-meta">16 September 2026 <span>•</span> Working manuscript <span>•</span> Local reading edition</div></header>
...
<footer>Research edition 0.1 · No human studies conducted · No comparative superiority established in this release<br>Corpus attribution: <a href="https://tanzil.net/">Tanzil Project</a>. The original file and its full notice are preserved in the source package.</footer>
